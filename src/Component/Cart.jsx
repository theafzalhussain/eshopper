                                    ...
                                    <tbody>
                                        {
                                            cart.map((item, index) => {
                                                return <tr key={index} className="text-center">
                                                    ...
                                                    <td className="price" style={{ display:"inline-block",width:"100px", marginTop:"25px"}}><button onClick={() => update(item.id, "dec")} className='' style={{ background: "none", width: "30px" }}> <i className="icon ion-ios-remove"></i></button>&nbsp;&nbsp;&nbsp;{item.qty}&nbsp;&nbsp;&nbsp;<button onClick={() => update(item.id, "inc")} className='' style={{ background: "none", width: "30px" }}><i className="icon ion-ios-add"></i></button></td>
