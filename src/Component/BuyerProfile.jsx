...
export default function BuyerProfile({ user }) {
    return (
        <>
            <h5 className=' Mytitle bg-info text-light text-center' style={{ width: "100%", fontSize: "20px", textTransform: "uppercase", letterSpacing: "2px", fontWeight: "500" }}>Buyer Profile</h5>
            ...
            <div>
                <Link to="/update-profile" className='btn btn-info mt-1' style={{ width: "100%" }}>Update Profile</Link>
            </div>
        </>
    )
}
