...
import { Users, ShoppingBag, DollarSign, Package, ShieldCheck, Mail, Phone, Edit3, ClipboardList } from 'lucide-react'
...
export default function AdminHome() {
    ...
    useEffect(() => {
        ...
        // Mapping string IDs accurately for live profile
            ...
            <div className="container-fluid px-lg-5">
                <div className="row">
                    ...
                    <div className="col-lg-9 col-md-8">
                        {/* Profile Overview Card (Preserving Original Design) */}
                        <motion.div 
                            ...
                            <div className="row no-gutters">
                                <div className="col-lg-4 bg-light d-flex flex-column align-items-center justify-content-center p-5 border-right">
                                    <img 
                                        ...
                                        style={{ height: "240px", width: "100%", objectFit: "cover", border: "5px solid white" }} 
                                        alt="Admin" 
                                    />
                                    <h4 className="font-weight-bold text-dark text-capitalize">{admin.name || "Administrator"}</h4>
                                    <p className="badge badge-info px-3 py-2 rounded-pill small">SUPER ADMIN</p>
                                </div>
                                <div className="col-lg-8 p-5">
                                    ...
                                    <div className="row">
                                        <div className="col-sm-6 mb-4">
                                            <p className="text-muted small uppercase ls-1 mb-1 font-weight-bold">Login Identity</p>
                                            <div className="font-weight-bold d-flex align-items-center">
                                                <ClipboardList size={16} className="text-info mr-2"/>
                                                @{admin.username || "admin_account"}
                                            </div>
                                        </div>
                                        <div className="col-sm-6 mb-4">
                                            <p className="text-muted small uppercase ls-1 mb-1 font-weight-bold">Direct Contact</p>
                                            <div className="font-weight-bold d-flex align-items-center">
                                                <Phone size={16} className="text-info mr-2"/>
                                                {admin.phone || "+91 000-0000"}
                                            </div>
                                        </div>
                                        <div className="col-sm-6 mb-4">
                                            <p className="text-muted small uppercase ls-1 mb-1 font-weight-bold">Management Email</p>
                                            <div className="font-weight-bold d-flex align-items-center">
                                                <Mail size={16} className="text-info mr-2"/>
                                                {admin.email || "loading..."}
                                            </div>
                                        </div>
                                        <div className="col-sm-6 mb-4">
                                            <p className="text-muted small uppercase ls-1 mb-1 font-weight-bold">Full Name</p>
                                            <div className="font-weight-bold d-flex align-items-center">
                                                <Edit3 size={16} className="text-info mr-2"/>
                                    ...
                                    <Link to="/update-profile" className='btn btn-info btn-block py-3 rounded-pill font-weight-bold shadow-lg transition hover-scale mt-3'>
                                        RE-CALIBRATE DASHBOARD CREDENTIALS
                                    </Link>
                                </div>
                            </div>
                        </motion.div>

                        {/* --- 📈 THE LIVE STATS GRID (Preserving Original Design) --- */}
                        <div className="row">
