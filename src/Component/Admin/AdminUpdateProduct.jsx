                        ...
                        <form className='p-3' onSubmit={postData}>
                            <div className="mb-3 p-3">
                                ...
                                <div className="row mb-3">
                                    <div className="col-lg-3 col-mb-6 col-12">
                                    ...
                                    <div className="col-lg-3 col-mb-6 col-12">
                                        ...
                                        <select name="stock" id="stock" onChange={getData} className="form-control">
                                            ...
                                            <option value="Out Stock" selected={"Out Of Stock"===data.stock}>Out Of Stock</option>
                                        </select>
                                    </div>
                                </div>
                                <div className="row mb-3">
                                    ...
                                    <div className="col-md-6 col-12">
                                        ...
                                        <input type="number" name='baseprice' id='baseprice' placeholder='Enter Baseprice' onChange={getData} className='form-control'value={data.baseprice} />
                                    </div>
                                    <div className="col-md-6 col-12">
