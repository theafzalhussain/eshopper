...
import { Edit3, Trash2, Plus, Grid, Search, FolderTree } from 'lucide-react'
...
export default function AdminSubcategory() {
    ...
    const filteredRows = useMemo(() => {
        let result = subcategory?.map((item) => ({
            ...item,
            id: item.id || item._id
        })) || []
                ...
                <div className="container-fluid px-lg-4 py-4">
                    ...
                    >
                        <div className="lux-banner-content">
                            <div>
                                <div className="lux-eyebrow"><FolderTree size={14} className="mr-1"/> Directory</div>
                                <h1 className="lux-banner-title">Sub <span>Categories</span></h1>
                                <p className="lux-banner-sub">Manage specialized product collections and sub-tiers.</p>
                            </div>
                    ...
                    <div className="w-100">
                        ...
                        >
                            ...
                            <div className="lux-toolbar">
                                ...
                                <Link to="/admin-add-subcategory" className="lux-btn-add">
                            ...
                            <div className="lux-table-responsive">
                                <table className="lux-table">
                                    <thead>
                                        <tr>
                                            <th className="hide-mobile">Collection ID</th>
                                            ...
                                            <tr>
                                                <td colSpan="3" className="text-center py-5">
                                                    <div className="text-muted d-flex flex-column align-items-center">
                                                        ...
                                                        <span>No sub-categories found matching your criteria.</span>
                                                    </div>
                                                </td>
                                            </tr>
                                        ) : (
                                            ...
                                            <tr key={row.id} className="lux-table-row">
                                                ...
                                                <td>
                                                    <div className="lux-cat-meta">
                                                        <div className="lux-cat-icon"><Grid size={16}/></div>
                                                ...
                                                <td className="text-right">
                                                    <div className="lux-action-cell">
                                                        ...
                                                        <button 
                                                            ...
                                                            onClick={() => {
                                                                if(window.confirm(`Delete collection "${row.name}"?`)) {
                                                                    toast.info("Deleting sub-category...");
