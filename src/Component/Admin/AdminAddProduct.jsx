                    ...
                    >
                        <div className="lux-banner-content">
                            <div>
                                ...
                                <h1 className="lux-banner-title">Add <span>Product</span></h1>
                                <p className="lux-banner-sub">Create a new boutique listing to your catalog.</p>
                            </div>
                                        ...
                                        {['pic1', 'pic2', 'pic3', 'pic4'].map((picName, index) => (
                                            <div className="col-6 col-md-3 mb-3 mb-md-0" key={picName}>
                                                <div className="lux-file-box">
                                                    <input type="file" name={picName} onChange={getFile} className="lux-file-input" accept="image/*" required={index === 0} />
                                                    <div className="lux-file-content">
                                                        {data[picName] && typeof data[picName] === 'object' ? (
                                                            <img src={URL.createObjectURL(data[picName])} alt="Preview" style={{height: '40px', objectFit: 'contain', marginBottom: '8px', borderRadius: '4px'}} />
                                                        ) : (
