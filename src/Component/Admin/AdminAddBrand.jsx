            ...
            <div className="container-fluid my-5">
                <div className="row">
                    ...
                    <div className="col-lg-10 col-12 mt-2">
                        <h5 className='bg-info text-center text-light p-2'>Brand <Link to="/admin-add-brand" className='float-right'><span className="material-symbols-outlined text-light">add</span></Link></h5>
