...
export default function About() {
    ...
    return (
        <div style={{ backgroundColor: "#ffffff", overflowX: "hidden" }}>
            ...
            {/* --- 3. OUR CORE PHILOSOPHY (Why Choose Us Fix) --- */}
            <section className="py-5 my-5">
                <div className="container">
                    <div className="row align-items-center">
                        <div className="col-md-6 order-2 order-md-1">
                            {/* Wrapper added to prevent image overflow */}
                            <motion.div 
                                className="shadow-2xl overflow-hidden rounded-3xl border"
                                initial="hidden" whileInView="visible" variants={fadeIn}
                            >
                                <img 
                                    src="assets/images/choose-2.jpg" 
                                    className="img-fluid w-100" 
                                    style={{ height: "550px", objectFit: "cover", display: "block" }}
                                    alt="Why Choose Us"
                                />
                            </motion.div>
                        </div>
            ...
            {/* --- 4. PRODUCTION EXCELLENCE (FIXED GRID & IMAGES) --- */}
                    ...
                    <div className="row g-4">
                        <div className="col-md-4">
                            <motion.div className="gallery-card rounded-2xl shadow-sm overflow-hidden" whileHover={{ y: -10 }}>
                                <img src="assets/images/choose-1.jpg" className="w-100 object-fit-cover" style={{ height: "450px" }} alt="Material Selection" />
                        ...
                        <div className="col-md-4">
                            <motion.div className="gallery-card rounded-2xl shadow-sm overflow-hidden" whileHover={{ y: -10 }}>
                                <img src="assets/images/choose-2.jpg" className="w-100 object-fit-cover" style={{ height: "450px" }} alt="Precision Stitching" />
                                <div className="gallery-overlay">
                        ...
                        <div className="col-md-4">
                            <motion.div className="gallery-card rounded-2xl shadow-sm overflow-hidden" whileHover={{ y: -10 }}>
                                <img src="/assets/productimages/kid.jpg" className="w-100 object-fit-cover" style={{ height: "450px" }} alt="Final Check" />
                                <div className="gallery-overlay">
            ...
            <style dangerouslySetInnerHTML={{ __html: `
                ...
                .gallery-card { position: relative; cursor: pointer; height: 450px; }
                .gallery-overlay {
