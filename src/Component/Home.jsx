...
export default function Home() {
	...
	// FIXED: Sorting for MongoDB (Latest products first)
	// We use spread operator [...] to create a copy before reversing
	...
	useEffect(() => {
		getAPIData()
	}, [product.length]) // Added dependency for real-time update

	return (
		<>
			<section
				id="home-section" className="hero Myslider">
					...
					<div className="row">
						{
							displayProducts.map((item,index)=>{
								...
								<div className="product d-flex flex-column">
									{/* FIXED: Removed local path, now using Cloudinary URL directly from item.pic1 */}
							...
							<div className="row no-gutters choose-wrap divider-two align-items-stretch">
								...
								<div className="col-md-12">
									<div className="row no-gutters">
										...
										<div className="col-md-6">
											<div className="choose-wrap wrap img align-self-stretch d-flex align-items-center" style={{ backgroundImage: "url('/assets/productimages/kid.jpg')" }}>
				...
				<div className="container-fluid px-0">
					<div className="row no-gutters">
						<div className="col-md-4 col-lg-2">
							<div className="gallery img d-flex align-items-center" style={{ backgroundImage: "url('/assets/images/gallery-1.jpg')" }}>
						...
						<div className="col-md-4 col-lg-2">
							<div className="gallery img d-flex align-items-center" style={{ backgroundImage: "url('/assets/images/gallery-2.jpg')" }}>
								<div className="icon mb-4 d-flex align-items-center justify-content-center">
									<span className="icon-instagram"></span>
								</div>
							</div>
						...
						<div className="col-md-4 col-lg-2">
							<div className="gallery img d-flex align-items-center" style={{ backgroundImage: "url('/assets/images/gallery-3.jpg')" }}>
								<div className="icon mb-4 d-flex align-items-center justify-content-center">
									<span className="icon-instagram"></span>
								</div>
							</div>
						...
						<div className="col-md-4 col-lg-2">
							<div className="gallery img d-flex align-items-center" style={{ backgroundImage: "url('/assets/images/gallery-4.jpg')" }}>
								<div className="icon mb-4 d-flex align-items-center justify-content-center">
									<span className="icon-instagram"></span>
								</div>
							</div>
						...
						<div className="col-md-4 col-lg-2">
							<div className="gallery img d-flex align-items-center" style={{ backgroundImage: "url('/assets/images/gallery-5.jpg')" }}>
								<div className="icon mb-4 d-flex align-items-center justify-content-center">
									<span className="icon-instagram"></span>
								</div>
							</div>
						...
						<div className="col-md-4 col-lg-2">
							<div className="gallery img d-flex align-items-center" style={{ backgroundImage: "url('/assets/images/gallery-6.jpg')" }}>
								<div className="icon mb-4 d-flex align-items-center justify-content-center">
									<span className="icon-instagram"></span>
								</div>
							</div>
