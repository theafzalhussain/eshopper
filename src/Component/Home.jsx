					...
					<div className="row">
						{
							product.map((item,index)=>{
								...
								<div className="product d-flex flex-column">
									<a target="_blank" href={`//assets/productimages/${item.pic1}`} className="img-prod"><img className="img-fluid" src={`/assets/productimages/${item.pic1}`} style={{height:"300px",width:"100%"}} alt="" />
				...
				{/* <div className="container">
					<div className="row justify-content-center">
						<div className="col-md-8 heading-section text-center mb-4 ftco-animate">
							...
							<h4 className="mb-2 icon-instagram"><a target="_blank" href='https://www.instagram.com/theafzal_hussain_786/'> theafzal_hussain_786</a></h4>
