...
const BRAND_LOGO_EMAIL_URL = process.env.BRAND_LOGO_EMAIL_URL || `${BRAND_SITE_URL}/logo-final-email.png`;
const BRAND_LOGO_PDF_SRC = `${BRAND_SITE_URL}/logo-final-invoice.png`;
